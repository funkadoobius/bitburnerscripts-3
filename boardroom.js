...
if (!player.hascorp) {
    //player.bitNodeN != 3
    if (selfFund) {
        const worked = corp.createcorp(rootname, selfFund);
...
let corp1 = corp.getcorp(); // corp1 stats
...
corp1 = corp.getcorp(); // corp1 stats
...
async function hrdepartment(ns) {
